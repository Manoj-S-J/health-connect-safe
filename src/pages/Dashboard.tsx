...
const Dashboard = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const hrStatus: VitalStatus = newHeartRate > 100 || newHeartRate < 60 ? 
        (newHeartRate > 120 || newHeartRate < 50 ? 'critical' : 'warning') : 'normal';
      const tempStatus: VitalStatus = newTemp > 37.8 || newTemp < 36.0 ? 
        (newTemp > 38.5 || newTemp < 35.0 ? 'critical' : 'warning') : 'normal';
      const oxyStatus: VitalStatus = newOxygen < 95 ? (newOxygen < 90 ? 'critical' : 'warning') : 'normal';
      const bpStatus: VitalStatus = newBP > 140 || newBP < 90 ? 
